...
public class VerifyCardArticlesPUMAFlow extends AbstractFlow {
    @Override
    ...
    @Story("Verify cards and related articles for PUMA users")
    @Description(
            """
                        Applicable cards for specific PUMA users are available in the required app sections.
