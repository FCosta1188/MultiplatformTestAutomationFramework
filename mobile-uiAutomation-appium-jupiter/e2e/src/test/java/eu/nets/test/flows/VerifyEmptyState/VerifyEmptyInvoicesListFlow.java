...
import static eu.nets.test.core.enums.MpaWidget.ACCOUNTING_INVOICES_EMPTY_STATE_TEXT;
import static eu.nets.test.core.enums.MpaWidget.ACCOUNTING_INVOICES_EMPTY_STATE_TITLE;
...
public class VerifyEmptyInvoicesListFlow extends AbstractFlow {
    ...
    protected void run(
        ...
        Allure.step("Open OVERVIEW -> Accounting -> Invoices and verify empty state", () -> {
            ...
            if(EnvUtil.isAndroid()) {
                ...
                driver.safeClick(ACCOUNTING_TAB.byAndroidXpathWithAttribute("text", "Invoices"), WAIT_10_S);
                driver.waitUntilElementVisible(ACCOUNTING_INVOICES_EMPTY_STATE_TITLE.byAndroidXpathWithResourceIdAndAttribute("text", "No Invoices yet"), WAIT_10_S);
                driver.scrollPercent(
                        driver.waitUntilElementVisible(By.xpath("//android.widget.ScrollView"), WAIT_10_S),
                        "down",
                        50
                );
                driver.waitUntilElementVisible(ACCOUNTING_INVOICES_EMPTY_STATE_TEXT.byAndroidXpathWithResourceIdAndAttribute("text", VerifyEmptyStateData.ACCOUNTING_INVOICES_EMPTY_STATE_TEXT), WAIT_10_S);
            } else if (EnvUtil.isIos()) {
                driver.safeClick(OVERVIEW_ACCOUNTING_BUTTON, WAIT_10_S);
                driver.safeClick(By.xpath("//XCUIElementTypeApplication[@name=\"MyPayments Pre-Prod\"]/XCUIElementTypeWindow[1][1]/XCUIElementTypeOther[1]/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton[2]"), WAIT_10_S);
                driver.waitUntilElementVisible(ACCOUNTING_INVOICES_EMPTY_STATE_TITLE, WAIT_10_S);
                driver.swipePercent(
                        driver.waitUntilElementVisible(By.xpath("//XCUIElementTypeTable[@name=\"settlement_table_view\"]"), WAIT_10_S),
                        "up",
                        50
                );
                driver.waitUntilElementVisible(ACCOUNTING_INVOICES_EMPTY_STATE_TEXT.byIosXpathWithName(VerifyEmptyStateData.ACCOUNTING_INVOICES_EMPTY_STATE_TEXT), WAIT_10_S);
            } else {
