...
public class VerifyNoResultsInvoicesListFlow extends AbstractFlow {
    ...
    protected void run(
        ...
        Allure.step("Open OVERVIEW -> Accounting -> Settlements and verify No Results filter", () -> {
            ...
            if(EnvUtil.isAndroid()) {
                ...
                driver.safeClick(ACCOUNTING_FILTER.byAndroidXpathWithResourceIdAndAttribute("text", "Invoice no"), WAIT_10_S);
                driver.safeSendKeys(ACCOUNTING_STATEMENT_NO_INPUT.byAndroidXpathWithResourceIdAndAttribute("text", "Invoice no"), WAIT_10_S, VerifyEmptyStateData.INVOICE_NO_INVALID);
                ...
                driver.safeClick(ACCOUNTING_FILTER.byIosXpathWithName("Invoice no"), WAIT_10_S);
                driver.safeSendKeys(ACCOUNTING_STATEMENT_NO_INPUT, WAIT_10_S, VerifyEmptyStateData.INVOICE_NO_INVALID);
