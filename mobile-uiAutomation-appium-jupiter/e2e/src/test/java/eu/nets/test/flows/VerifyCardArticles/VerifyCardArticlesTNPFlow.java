...
public class VerifyCardArticlesTNPFlow extends AbstractFlow {
    @Override
    ...
    @Story("Verify cards and related articles for TNP users")
    @Description(
            """
                        Applicable cards for specific TNP users are available in the required app sections.
