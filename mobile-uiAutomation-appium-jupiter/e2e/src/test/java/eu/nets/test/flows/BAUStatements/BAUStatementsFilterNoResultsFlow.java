...
public class BAUStatementsFilterNoResultsFlow extends AbstractFlow {
    @Override
    ...
    protected void run(
        ...
        new BAUStatementsFilterBaseFlow().run(user, appLanguage, BAUStatementsData.Filter.NO_RESULTS);
    }
}
