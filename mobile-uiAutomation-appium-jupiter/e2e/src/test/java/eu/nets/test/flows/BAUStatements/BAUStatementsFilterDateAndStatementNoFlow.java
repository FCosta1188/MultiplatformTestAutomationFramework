...
public class BAUStatementsFilterDateAndStatementNoFlow extends AbstractFlow {
    @Override
    ...
    protected void run(
        ...
        new BAUStatementsFilterBaseFlow().run(user, appLanguage, BAUStatementsData.Filter.DATE_AND_STATEMENT_NO);
    }
}
