...
public class VerifyCardArticlesBAUFlow extends AbstractFlow {
    @Override
    ...
    @Story("Verify cards and related articles for BAU users")
    @Description(
            """
                        Applicable cards for specific BAU users are available in the required app sections.
