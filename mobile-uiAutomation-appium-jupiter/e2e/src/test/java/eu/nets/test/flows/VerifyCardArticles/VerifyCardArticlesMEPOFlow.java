...
public class VerifyCardArticlesMEPOFlow extends AbstractFlow {
    @Override
    ...
    @Story("Verify cards and related articles for MEPO users")
    @Description(
            """
                        Applicable cards for specific MEPO users are available in the required app sections.
