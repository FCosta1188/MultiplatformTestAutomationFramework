...
public class BAUStatementsFilterStatementNoFlow extends AbstractFlow {
    @Override
    ...
    protected void run(
        ...
        new BAUStatementsFilterBaseFlow().run(user, appLanguage, BAUStatementsData.Filter.STATEMENT_NO);
    }
}
